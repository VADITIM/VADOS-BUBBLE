...
| **Duplicate** | Bottom of the screen, centred, for as long as the Notifications menu stands. Born on the Main bubble and travelling down when the menu opens, carrying that bubble's measured box rather than a shape of its own and merging back into it on the close. | built | no |
